/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: df16bea09fae1ef6332e4b2cff137343)
// Runtime types generated with workerd@1.20260801.1 2026-08-07 nodejs_compat
interface __BaseEnv_Env {
	ACCOUNTS_DB: D1Database;
	APP_BASE_URL?: "https://hbrosenius.github.io/GolfCalulator/";
	ACCOUNT_API_BASE?: "https://golfcalc-sync.golfcalc-sync.workers.dev" | "https://golfcalc-sync-staging.golfcalc-sync.workers.dev";
	ACCOUNT_FROM_EMAIL?: "Poängbogey <login@golf.brosenius.se>";
	GOLF_ROOMS: DurableObjectNamespace<import("./src/index").GolfRoom>;
	GOLF_TOURS: DurableObjectNamespace<import("./src/index").Tour>;
	CREATE_LIMITER: DurableObjectNamespace<import("./src/index").CreateRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GolfRoom" | "Tour" | "CreateRateLimiter";
	}
	interface ProductionEnv {
		ACCOUNTS_DB: D1Database;
		APP_BASE_URL: "https://hbrosenius.github.io/GolfCalulator/";
		ACCOUNT_API_BASE: "https://golfcalc-sync.golfcalc-sync.workers.dev";
		ACCOUNT_FROM_EMAIL: "Poängbogey <login@golf.brosenius.se>";
		GOLF_ROOMS: DurableObjectNamespace<import("./src/index").GolfRoom>;
		GOLF_TOURS: DurableObjectNamespace<import("./src/index").Tour>;
		CREATE_LIMITER: DurableObjectNamespace<import("./src/index").CreateRateLimiter>;
	...
	interface StagingEnv {
		ACCOUNTS_DB: D1Database;
		APP_BASE_URL: "https://hbrosenius.github.io/GolfCalulator/";
		ACCOUNT_API_BASE: "https://golfcalc-sync-staging.golfcalc-sync.workers.dev";
		ACCOUNT_FROM_EMAIL: "Poängbogey <login@golf.brosenius.se>";
		GOLF_ROOMS: DurableObjectNamespace<import("./src/index").GolfRoom>;
		GOLF_TOURS: DurableObjectNamespace<import("./src/index").Tour>;
		CREATE_LIMITER: DurableObjectNamespace<import("./src/index").CreateRateLimiter>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_BASE_URL" | "ACCOUNT_API_BASE" | "ACCOUNT_FROM_EMAIL">> {}
}
