...
Med exakt 2 spelare bildar ni ett gemensamt lag istället för två lag — praktiskt för att hålla score när ni spelar scramble tillsammans mot en annan bollsällskap som räknas separat. Ni kan ange ett **minsta antal utslag per spelare** (Texas Scramble-regeln), och för varje hål väljer ni vems utslag som användes. Under scoreinmatningen syns en löpande räknare (t.ex. "Anna: 3/6 · Björn: 2/6 · 12 hål kvar") som varnar med rött och ⚠️ om en spelare inte längre kan nå minimikravet med kvarvarande hål. Resultatsidan visar hur många utslag respektive spelare bidragit med och flaggar om kravet inte uppfylldes.

Eftersom ett scramble-lag med bara 2 spelare (utan motståndarlag) inte har någon att jämföra individuella prestationer mot, visas inte **Närmast pinnen** eller **Längsta drive** i det läget.
