...
- **Gemensam bankatalog** — sök efter publicerade banor och importera alla tees med slope, CR, par och håldata; efter import fungerar banan offline precis som en manuellt sparad bana
